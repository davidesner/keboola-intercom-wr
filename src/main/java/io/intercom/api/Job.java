...
public class Job extends TypedData {
    ...
    public boolean equals(Object o) {
        ...
        if (createdAt != job.createdAt) {
            return false;
        }
        if (updatedAt != job.updatedAt) {
            return false;
        }
        if (completedAt != job.completedAt) {
            return false;
        }
        ...
        if (appID != null ? !appID.equals(job.appID) : job.appID != null) {
            return false;
        }
        ...
        if (state != null ? !state.equals(job.state) : job.state != null) {
            return false;
        }
